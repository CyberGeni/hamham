...
import Adam from "/src/assets/images/adam-mura.png";
import Michael from "/src/assets/images/michael-yonke.png";
import Uros from "/src/assets/images/uros-mikic.png";
function Reviews() {
  const reviews = [
    {
      id: 1,
      name: "Adam Mura",
      quote:
        "This is the place I go when I need fresh inspiration for hamburger menu designs.",
      image: Adam,
    },
    {
      id: 2,
      name: "Michael Yonke",
      quote:
        "That Triple Tirado almost gave me a triple bypass...Totally worth it!",
      image: Michael,
    },
    {
      id: 3,
      name: "Uros Mikic",
      quote:
        "The hype is real. After waiting hours in line, the burgers exceeded my expectation.",
      image: Uros,
    },
  ];
    ...
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-10 w-5/6 sm:w-11/12 md:w-10/12 mx-auto py-6">
      {reviews.map((review) => (
        ...
        >
          ...
          <p className="my-5">"{review.quote}"</p>
          <div className="flex items-center space-x-2">
            <img className="w-8 md:w-11 h-8 md:h-11" src={review.image} alt="" />
            <h4 className="text-sm sm:text-base font-medium">{review.name}</h4>
          </div>
        </div>
      ))}
    </div>
