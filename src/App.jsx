      ...
      <section className="bg-[#E4DDCD]">
        <div className="flex justify-between items-end w-[85%] mx-auto py-12">
          ...
          <button className="flex items-center border-[#1e1e1e] border rounded-full px-3.5 sm:px-5 md:px-7 py-2 md:py-3 text-sm">
            ...
            >
              <path
                d="M7.67347 17.9085C10.6527 17.9085 13.0678 15.4933 13.0678 12.5141C13.0678 9.53489 10.6527 7.11975 7.67347 7.11975C4.69425 7.11975 2.27911 9.53489 2.27911 12.5141C2.27911 15.4933 4.69425 17.9085 7.67347 17.9085Z"
                fill="black"
                stroke="black"
                stroke-width="2"
              ...
              />
              <path
                d="M8.82627 7.24457C7.98405 8.46125 7.65459 10.0049 7.99726 11.5102L10.4661 11.4169L8.64337 13.1121C9.42201 14.4026 10.6907 15.2783 12.106 15.5896C13.0952 14.1607 13.3776 12.281 12.6943 10.5416C12.011 8.80268 10.5243 7.61779 8.82668 7.24457H8.82627Z"
                fill="black"
                stroke="black"
                stroke-width="2"
                stroke-miterlimit="10"
              />
              <path
                d="M7.68019 18.1629C5.42477 18.1629 3.2899 16.8029 2.4163 14.5801C1.27723 11.6815 2.7086 8.39596 5.60766 7.2569C7.01178 6.70491 8.54718 6.73299 9.93025 7.33575C11.3133 7.93852 12.3789 9.04373 12.9309 10.4478C13.4829 11.852 13.4548 13.3874 12.852 14.7704C12.2493 16.1535 11.144 17.2195 9.73992 17.7711C9.06408 18.0369 8.36635 18.1624 7.6806 18.1624L7.68019 18.1629ZM7.67482 7.37126C7.03944 7.37126 6.40282 7.49057 5.79345 7.73003C3.15572 8.76671 1.85275 11.7562 2.88943 14.3939C3.92611 17.0321 6.916 18.3346 9.55372 17.2979C10.8315 16.7959 11.8372 15.8261 12.3859 14.5673C12.9342 13.3085 12.9598 11.9118 12.4577 10.634C11.9557 9.35626 10.9859 8.35055 9.72712 7.80187C9.06862 7.51493 8.37255 7.37126 7.67482 7.37126Z"
                fill="black"
                stroke="black"
                stroke-width="2"
                stroke-miterlimit="10"
              />
              <path
                d="M7.69448 0.837158V4.0277C7.69448 4.0277 3.34382 2.86758 0.00878696 8.08812C0.00878696 8.08812 -0.571275 3.1574 7.69448 0.837158Z"
                fill="black"
              />
              <path
                d="M21.3039 1.12789L21.4983 3.00307C21.4983 3.00307 25.631 0.679115 28 5.24487C28 5.24487 27.0141 -0.0470961 21.3039 1.12789Z"
                fill="black"
              />
              <path
                d="M7.67347 17.9085C10.6527 17.9085 13.0678 15.4933 13.0678 12.5141C13.0678 9.53489 10.6527 7.11975 7.67347 7.11975C4.69425 7.11975 2.27911 9.53489 2.27911 12.5141C2.27911 15.4933 4.69425 17.9085 7.67347 17.9085Z"
              ...
              />
              <path
                d="M20.5118 17.9085C23.4911 17.9085 25.9062 15.4933 25.9062 12.5141C25.9062 9.53489 23.4911 7.11975 20.5118 7.11975C17.5326 7.11975 15.1175 9.53489 15.1175 12.5141C15.1175 15.4933 17.5326 17.9085 20.5118 17.9085Z"
                fill="black"
                stroke="black"
                stroke-width="2"
                stroke-miterlimit="10"
              />
              <path
                d="M21.6646 7.24457C20.8224 8.46125 20.493 10.0049 20.8356 11.5102L23.3045 11.4169L21.4818 13.1121C22.2604 14.4026 23.5291 15.2783 24.9444 15.5896C25.9336 14.1607 26.216 12.281 25.5327 10.5416C24.8494 8.80268 23.3627 7.61779 21.6651 7.24457H21.6646Z"
                fill="black"
                stroke="black"
                stroke-width="2"
                stroke-miterlimit="10"
              />
              <path
                d="M20.5186 18.1629C18.2631 18.1629 16.1283 16.8029 15.2547 14.5801C14.1156 11.6815 15.547 8.39596 18.446 7.2569C19.8502 6.70491 21.3856 6.73299 22.7686 7.33575C24.1517 7.93852 25.2173 9.04373 25.7693 10.4478C26.3212 11.852 26.2932 13.3874 25.6904 14.7704C25.0876 16.1535 23.9824 17.2195 22.5783 17.7711C21.9025 18.0369 21.2047 18.1624 20.519 18.1624L20.5186 18.1629ZM20.5132 7.37126C19.8778 7.37126 19.2412 7.49057 18.6318 7.73003C15.9941 8.76671 14.6911 11.7562 15.7278 14.3939C16.7645 17.0321 19.7544 18.3346 22.3921 17.2979C23.6699 16.7959 24.6756 15.8261 25.2243 14.5673C25.7726 13.3085 25.7982 11.9118 25.2961 10.634C24.7941 9.35626 23.8243 8.35055 22.5655 7.80187C21.907 7.51493 21.2109 7.37126 20.5132 7.37126Z"
                fill="black"
                stroke="black"
                stroke-width="2"
                stroke-miterlimit="10"
